...
char    *replace_each_obj_match_by_str(char *src, char *obj, char *str);
int count_until_obj_in_str(char *str, char *obj);
int find_nb_match_of_obj_in_str(char *str, char *obj);
